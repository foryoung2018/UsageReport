 ...
 *
 */
public class SEGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
     ...
     */
    public SEGLSurfaceView(Context context) {
        super(context);
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public SEGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
        ...
        public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            ...
            for (EGLConfig config : configs) {
                ...
                if (d>=mDepthSize && s>=mStencilSize) {
                    final int r = findConfigAttrib(egl, display, config, EGL10.EGL_RED_SIZE, 0) - mRedSize;
                    final int g = findConfigAttrib(egl, display, config, EGL10.EGL_GREEN_SIZE, 0) - mGreenSize;
                    final int b = findConfigAttrib(egl, display, config, EGL10.EGL_BLUE_SIZE, 0) - mBlueSize;
                    final int a = findConfigAttrib(egl, display, config, EGL10.EGL_ALPHA_SIZE, 0) - mAlphaSize;
                    final int distance = r*r + g*g + b*b + a*a;
     ...
     * RGB888 as possible, with or without a depth buffer.
     *
     */
