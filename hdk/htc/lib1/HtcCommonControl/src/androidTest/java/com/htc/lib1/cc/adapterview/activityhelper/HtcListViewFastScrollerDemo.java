 ...
 */
public class HtcListViewFastScrollerDemo extends ActivityBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MyAdapter(
                this, R.layout.htclistview_demo_htc_fastscroller_item_layout, ENTRIES);
    ...
    {
        HtcListView mListViewNew = new HtcListView(this);
        mListViewNew.enableAnimation(IHtcAbsListView.ANIM_INTRO, true);
        mListViewNew.isOverScrolledAnimationEnabled();
        mListViewNew.setFooterDividersEnabled(false);
        mListViewNew.setHeaderDividersEnabled(false);
        mListViewNew.setOverscrollFooter(null);
        mListViewNew.setOverscrollHeader(null);
    }
}
