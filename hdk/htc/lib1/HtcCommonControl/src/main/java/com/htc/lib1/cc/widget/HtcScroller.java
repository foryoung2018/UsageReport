        ...
        if (timePassed < mDuration) {
            ...
            case SCROLL_MODE:
                ...
                if(mEasingFunction != null){
                    mCurrX = (int)mEasingFunction.currentResult(0, timePassed, mStartX, mDeltaX, mDuration);
                    mCurrY = (int)mEasingFunction.currentResult(0, timePassed, mStartY, mDeltaY, mDuration);
                }
                else {
 ...
 */
   ...
   float getCurrVelocity() {
       int timePassed = (int)(AnimationUtils.currentAnimationTimeMillis() - mStartTime);
       float timePassedSeconds = timePassed / 1000.0f;
       return mVelocity - mDeceleration * timePassedSeconds;
   }
}
