 ...
 */
public abstract class AbstractAdapterView<T extends Adapter> extends ViewGroup {
 ...
 */
    ...
    public AbstractAdapterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //[Ahan][2012/11/28][Add to support Accessibility]
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(AbstractAdapterView<?> parent, View view, int position, long id);
    }
 ...
 */
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(AbstractAdapterView<?> parent, View view, int position, long id);
    }
 ...
 */
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(AbstractAdapterView<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(AbstractAdapterView<?> parent);
    }
 ...
 */
        ...
        public void onChanged() {
            ...
            if (AbstractAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                AbstractAdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
 ...
 */
        ...
        public void onInvalidated() {
            ...
            if (AbstractAdapterView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = AbstractAdapterView.this.onSaveInstanceState();
            }
 ...
 *  @hide
 */
    public void blockLayoutRequests(boolean block){
        mBlockLayoutRequests = block;
    }
}
