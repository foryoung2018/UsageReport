 ...
 * {@link com.htc.view.viewpager.HtcFragmentPagerAdapter} or
 * {@link com.htc.view.viewpager.HtcFragmentStatePagerAdapter}.
 *
...
public abstract class HtcPagerAdapter implements TabBar.TabAdapter {
    ...
    boolean mPageTitleStrategyImplemented = true;

    public HtcPagerAdapter() {
    }
    ...
    public CharSequence getPageTitle(int position) {
        mPageTitleStrategyImplemented = false;
        return null;
    }

    /**
     * This method may be called by the ViewPager to obtain a count
     * to describe the specified page. This method may return 0
     * indicating no count for this page. The default implementation returns
     * 0.
     *
     * @param position The position of the title requested
     * @return A title for the requested page
    ...
    /**
     * {@inheritDoc}
     * @see com.htc.fragment.widget.PageTitleStrategy#isAutomotiveMode()
     */
    @Override
    ...
    /**
     * saving reorder data for recording current tab sequence
     * @hide
     */
