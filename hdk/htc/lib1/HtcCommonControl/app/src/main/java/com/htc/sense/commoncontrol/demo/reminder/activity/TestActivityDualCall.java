...
import com.htc.sense.commoncontrol.demo.reminder.ui.TestViewDualCall;

public class TestActivityDualCall extends CommonDemoActivityBase {

    TestViewDualCall mTestView;
    String TAG = "TestActivityDualCall";
    ...
    protected void onCreate(Bundle arg0) {
        ...
        setContentView(R.layout.main_dual_call);
        mTestView = (TestViewDualCall) this.findViewById(R.id.test_reminder_view);
        ...
        if (mTestView != null) {
            mTestView.setCallback(new TestViewDualCall.Callback() {
                @Override
