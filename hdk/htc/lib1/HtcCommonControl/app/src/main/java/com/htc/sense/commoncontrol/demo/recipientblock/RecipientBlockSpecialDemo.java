package com.htc.sense.commoncontrol.demo.recipientblock;
...
public class RecipientBlockSpecialDemo extends CommonDemoActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipient_block_special_demo);
    ...
    private void removeAllRecipient(){
        if(mComposeRecipientArea!=null)
            mComposeRecipientArea.updateNewRecipients(null);
    }
    ...
    private View.OnKeyListener toKeyEvent= new View.OnKeyListener() {
    ...
    private View.OnClickListener mCCListener = new View.OnClickListener() {
        public void onClick(View v) {
    ...
    private ComposeRecipientArea.ComposeRecipientCallBack mComposeRecipientCallBack = new ComposeRecipientArea.ComposeRecipientCallBack() {
        ...
        public void onReceiverButtonClick(final ComposeRecipientArea composeRecipientArea, final ReceiverList receiver) {
            ...
            HtcAlertDialog.Builder builder = new HtcAlertDialog.Builder(RecipientBlockSpecialDemo.this);
        ...
        //Implement the function for after adding single receiver to Recipient Block, like mail and calendar will increae the frequency of the receiver
        public void afterAddSingleReceiver(ComposeRecipientArea composeRecipientArea, ReceiverList receiver, boolean plusFrequency) {

        }

        //Implement the function for after adding several receivers to Recipient Block, like mail and calendar will increae the frequency of the receiver
        ...
        //Implement the function for after removing single receiver to Recipient Block, like mail and calendar will increae the frequency of the receiver
    ...
    public void hideShowActionBar(View view) {
