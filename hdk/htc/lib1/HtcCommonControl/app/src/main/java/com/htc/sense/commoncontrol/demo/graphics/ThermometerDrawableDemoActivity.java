...
package com.htc.sense.commoncontrol.demo.graphics;
...
public class ThermometerDrawableDemoActivity extends CommonDemoActivityBase {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.thermometer_drawable_layout);
