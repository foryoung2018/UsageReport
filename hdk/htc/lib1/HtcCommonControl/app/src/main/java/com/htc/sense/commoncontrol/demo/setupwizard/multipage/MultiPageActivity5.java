...
import com.htc.sense.commoncontrol.demo.setupwizard.DemoSpecialActivity;
import com.htc.sense.commoncontrol.demo.util.CommonUtil;
import com.htc.lib1.cc.widget.setupwizard.WizardConstants;

public class MultiPageActivity5 extends DemoSpecialActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setNextBtnText(com.htc.lib1.cc.R.string.va_finish);
   }
}
