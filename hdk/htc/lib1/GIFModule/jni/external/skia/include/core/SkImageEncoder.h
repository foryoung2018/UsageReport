...
// HTC::
    bool encodeStream(SkWStream*, const SkBitmap&, int quality, char *chunktag, unsigned char *p_payload, int len);
// ::HTC
...
// HTC::
    virtual bool onEncode(SkWStream*, const SkBitmap&, int quality, char *chunktag, unsigned char *p_payload, int len) {  return false; }
// ::HTC
};
