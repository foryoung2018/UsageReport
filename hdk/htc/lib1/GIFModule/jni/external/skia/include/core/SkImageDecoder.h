...
public:
    ...
    */
    ...
    // HTC:: Jason for PNG
    bool decodeUserData(SkStream*, char  *chunkTag, char **ppdata, int *pSize, bool bDecode, bool *pWithChunk);
    // ::HTC
...
protected:
    ...
    // HTC::
    virtual bool onDecodeUserData(SkStream*, char *pChunkTag, char **ppData, int *pSize, bool bDecode, bool *pWithChunk) { return false; }
    // ::HTC
