...
import com.htc.lib1.htcmp4parser.coremedia.iso.boxes.AbstractMediaHeaderBox;
...
import com.htc.lib1.htcmp4parser.coremedia.iso.boxes.sampleentry.VisualSampleEntry;
...
import com.htc.lib1.htcmp4parser.googlecode.mp4parser.h264.model.ChromaFormat;
...
import com.htc.lib1.htcmp4parser.googlecode.mp4parser.h264.read.CAVLCReader;
...
public class H264TrackImpl extends AbstractTrack {
    ...
    public H264TrackImpl(InputStream inputStream) throws IOException {
        ...
        if (seqParameterSet != null) {
            ...
            final ChromaFormat chroma_format_idc = seqParameterSet.chroma_format_idc;
            if (chroma_format_idc != null) {
            	avcConfigurationBox.setChromaFormat(chroma_format_idc.getId());
            } else {
            	Log.e(H264TrackImpl.class.getName(), "seqParameterSet.chroma_format_idc is null");
            }
        } else {
        	Log.e(H264TrackImpl.class.getName(), "seqParameterSet is null");
        }
...
//                printAccessUnitDelimiter(data);
    ...
    public class SEIMessage {
            ...
            while (read < datasize) {
                ...
                if (datasize - read >= payloadSize) {
                    if (payloadType == 1) { // pic_timing is what we are interested in!
                        if (sps != null && sps.vuiParams != null && (sps.vuiParams.nalHRDParams != null || sps.vuiParams.vclHRDParams != null || sps.vuiParams.pic_struct_present_flag)) {
        ...
        public String toString() {
            ...
            out.append("SEIMessage{" +
                    "payloadType=" + payloadType +
                    ", payloadSize=" + payloadSize);
            if (payloadType == 1) {
                if (sps.vuiParams.nalHRDParams != null || sps.vuiParams.vclHRDParams != null) {

                    out.append(", cpb_removal_delay=" + cpb_removal_delay +
                            ", dpb_removal_delay=" + dpb_removal_delay);
                }
                if (sps.vuiParams.pic_struct_present_flag) {
                    out.append(", pic_struct=" + pic_struct);
                    if (clock_timestamp_flag) {
                        out.append(", ct_type=" + ct_type +
