...
public class MovieFragmentBox extends AbstractContainerBox {
    ...
    public long[] getTrackNumbers() {
        ...
        for (int trackCounter = 0; trackCounter < trackBoxes.size(); trackCounter++) {
            ...
            final TrackFragmentHeaderBox trackFragmentHeaderBox = trackBoxe.getTrackFragmentHeaderBox();
            if (trackFragmentHeaderBox != null) {
            	trackNumbers[trackCounter] = trackFragmentHeaderBox.getTrackId();
            } else {
            	android.util.Log.e(MovieFragmentBox.class.getName(), "Get trackFragmentHeaderBox is null");
            }            
        }
        return trackNumbers;
    }
