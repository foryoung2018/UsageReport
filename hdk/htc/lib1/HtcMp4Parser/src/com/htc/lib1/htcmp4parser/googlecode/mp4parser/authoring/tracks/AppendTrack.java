...
import com.htc.lib1.htcmp4parser.googlecode.mp4parser.boxes.mp4.objectdescriptors.DecoderConfigDescriptor;
import com.htc.lib1.htcmp4parser.googlecode.mp4parser.boxes.mp4.objectdescriptors.ESDescriptor;
...
public class AppendTrack extends AbstractTrack {
	...
	public List<SampleOffset> getSampleOffsets() {
		ArrayList<SampleOffset> lists = new ArrayList<SampleOffset>();

        for (Track track : tracks) {
            final List<ByteBuffer> samples = track.getSamples();
        	if (samples instanceof SampleList)        	
        	lists.addAll( ((SampleList)samples).getSampleOffsets() );
        }
