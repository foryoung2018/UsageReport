...
import com.htc.lib1.exo.text.HtcTextTrackRenderer;
...
public class DemoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    HtcMediaCodecVideoTrackRenderer.EventListener, HtcMediaCodecAudioTrackRenderer.EventListener,
  ...
  public void setInternalErrorListener(InternalErrorListener listener) {
    LOG.I(TAG,"setInternalErrorListener");
    internalErrorListener = listener;
  }

  public void setInfoListener(InfoListener listener) {
    LOG.I(TAG,"setInfoListener");
    infoListener = listener;
  }

  public void setCaptionListener(CaptionListener listener) {
    LOG.I(TAG,"setCaptionListener");
  ...
  public void blockingClearSurface() {
    LOG.I(TAG,"blockingClearSurface");
    surface = null;
    pushSurface(true);
  }
  ...
  public void selectTrack(int type, int index) {
    LOG.I(TAG,"selectTrack(" + type + "," + index + ")");
  ...
  public void onPlayerStateChanged(boolean playWhenReady, int state) {
    LOG.I(TAG,"onPlayerStateChanged " + playWhenReady + "," + state );
    maybeReportPlayerState();
  }
  ...
  public void onVideoSizeChanged(int width, int height, float pixelWidthHeightRatio) {
    LOG.I(TAG,"onVideoSizeChanged(" + width + "," + height + "," + pixelWidthHeightRatio + ")");
    int degree = getVideoRotateDegree();
    LOG.I(TAG,"onVideoSizeChanged degree = " + degree);
    for (Listener listener : listeners) {
      if ((degree == 90 || degree == 270) && pixelWidthHeightRatio > 0)
        listener.onVideoSizeChanged(height, width, 1.0f / pixelWidthHeightRatio);
      else
  ...
  public void onDrmSessionManagerError(Exception e) {
    LOG.I(TAG,"onDrmSessionManagerError");
    if (internalErrorListener != null) {
  ...
  public void onAudioSessionIdReady(int audioSessionId) {
    LOG.I(TAG,"onAudioSessionIdReady");
  ...
  private void maybeReportPlayerState() {
    ...
    if (lastReportedPlayWhenReady != playWhenReady || lastReportedPlaybackState != playbackState) {
      ...
      if (lastReportedPlayWhenReady != playWhenReady)
          LOG.I(TAG,"maybeReportPlayerState [playWhenReady = " + lastReportedPlayWhenReady + " -> " + playWhenReady + "]");

      if (lastReportedPlaybackState != playbackState)
          LOG.I(TAG,"maybeReportPlayerState [playbackState = " + lastReportedPlaybackState + " -> " + playbackState + "]");
  ...
  private void pushSurface(boolean blockForSurfacePush) {
    ...
    if (blockForSurfacePush) {
      player.blockingSendMessage(
          videoRenderer, HtcMediaCodecVideoTrackRenderer.MSG_SET_SURFACE, surface);
    } else {
      player.sendMessage(
          videoRenderer, HtcMediaCodecVideoTrackRenderer.MSG_SET_SURFACE, surface);
    }
  ...
  public HtcMediaCodecVideoTrackRenderer getVideoRenderer()
  {
  ...
  public HtcMediaCodecAudioTrackRenderer getAudioRenderer()
  {
      if (mRenderers == null) return null;
  ...
  public HtcTextTrackRenderer getTextRenderer()
  {
      if (mRenderers == null) return null;

      TrackRenderer myRenderer = mRenderers[DemoPlayer.TYPE_TEXT];              
      if (myRenderer != null && myRenderer instanceof HtcTextTrackRenderer)
      {
          HtcTextTrackRenderer renderer = (HtcTextTrackRenderer) myRenderer;
          return renderer;
      }
      return null;           
  }
  ...
  public void setAudioSpeed(float speed)
  {
      ...
      if (aRenderer != null && playbackParams != null)
      {
          playbackParams.setSpeed(speed);
          playbackParams.setPitch(speed);
          aRenderer.setAudioPlaybackSpeed(playbackParams);
      }

  }

  public void updatePlaySpeed(float multiple)
  {
      LOG.I(TAG,"updatePlaySpeed(" + multiple + ")");

      HtcMediaCodecVideoTrackRenderer vRenderer = getVideoRenderer();
      if (vRenderer != null)
      {
          vRenderer.setPlayRate(multiple);
      }
      ...
      if (tRenderer != null)
      {
          tRenderer.setPlayRate(multiple);
      }
  }

  public void setVolume (float leftVolume, float rightVolume) throws Exception
  {
      HtcMediaCodecAudioTrackRenderer aRenderer = getAudioRenderer();
      if (aRenderer != null)
      {
          if (leftVolume == rightVolume)
              aRenderer.setVolume(leftVolume);
          else
              throw new Exception("leftVolume != rightVolume");
      }
  }

  private int getVideoRotateDegree()
  {
      HtcMediaCodecVideoTrackRenderer vRenderer = getVideoRenderer();
      if (vRenderer != null)
      {
          return vRenderer.getVideoRotateDegree();
      }
      return 0;
  }
}
