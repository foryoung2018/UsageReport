...
public final class DataSpec {
  ...
  public DataSpec(Uri uri, long absoluteStreamPosition, long length, String key, int flags) {
    this(uri, absoluteStreamPosition, absoluteStreamPosition, length, key, flags, -1 /* Htc defined*/);
  }
  ...
  public DataSpec(Uri uri, long absoluteStreamPosition, long position, long length, String key,
      int flags, long positionUs/* Htc defined*/) {
  ...
  public String toString() {
    return "DataSpec[" + uri + ", " + absoluteStreamPosition + ", " + position + ", " + length
        + ", " + key + ", " + flags + "," + positionInUs + "]";
  }
  //[htc]Add by OOD, for DLNA time seek, start
  public DataSpec(Uri uri, long absoluteStreamPosition, long position, long length, String key,
      int flags) {
    this(uri, absoluteStreamPosition, position, length, key,
      flags, -1) ;
  }

  public final long positionInUs;
  //[htc]Add by OOD, for DLNA time seek, end
}
