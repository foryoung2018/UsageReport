...
public final class AtomParsers {
  ...
  public static Track parseTrak(Atom.ContainerAtom trak, Atom.LeafAtom mvhd) {
    ...
    if (header.first < 0 ) {
	header = parseTkhd(trak.getLeafAtomOfType(Atom.TYPE_htka).data);
    }
    int id = header.first;
   ...
   */
  public static long parseMvhd(ParsableByteArray mvhd) {
   ...
   */
  public static Pair<Integer, Long> parseTkhd(ParsableByteArray tkhd) {
   ...
   */
  public static int parseHdlr(ParsableByteArray hdlr) {
   ...
   */
  public static long parseMdhd(ParsableByteArray mdhd) {
  ...
  public static StsdDataHolder parseStsd(ParsableByteArray stsd, long durationUs) {
