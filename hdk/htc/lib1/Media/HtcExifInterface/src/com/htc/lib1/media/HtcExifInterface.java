 ...
 */
public class HtcExifInterface {
    /* >> Harvey add more logs to trace */
    public static final String TAG = "HtcExifInterface";
    /* << Harvey add more logs to trace */
    ...
    /* >> Harvey add panorama tag */
    /** Type is int. */
    public static final String TAG_PANORAMA = "PanoPlus";
    /* << Harvey add panorama tag */
    
    /* >> Harvey add DualCam tag */
    /** Type is int. */
    public static final String TAG_DUAL_CAM = "DualCam";
    /** Type is int. */
    public static final String TAG_MAKER_NOTE_TAG_NUM= "MakerNoteTagNum";
    /** Type is int. */
    public static final String TAG_VCM = "Vcm";
    /** Type is int. */
    public static final String TAG_FOCUS_AREA_X1 = "FocusArea.x1";
    /** Type is int. */
    public static final String TAG_FOCUS_AREA_Y1 = "FocusArea.y1";
    /** Type is int. */
    public static final String TAG_FOCUS_AREA_X2 = "FocusArea.x2";
    /** Type is int. */
    public static final String TAG_FOCUS_AREA_Y2 = "FocusArea.y2";
    /** Type is int. */
    public static final String TAG_DUAL_CAM_HASFACE = "DualHasFace";
    /** Type is int. */
    public static final String TAG_DUAL_CAM_HASDEPTH = "DualHasDepth";
    /** Type is int. */
    public static final String TAG_DUAL_CAM_ISPROCESSED = "DualIsProcessed";  


    /* << Harvey add DualCam tag */
    
    /** Type is int. */
    public static final String TAG_MACRO_3D = "Macro3D";
    /** Type is int. */
    public static final String TAG_BOKEH = "Bokeh";

    /* >> Fengjen add for detect camera id */
    /** Type is int. */
    public static final String TAG_CAMERA_ID = "CameraID";
    /* << Fengjen add for detect camera id */

    /* >> Harvey add for detect raw image */
    public static final String TAG_PHOTOLAB_FLAG = "PhotolabExFlag";
    /* << Harvey add for detect raw image */
    ...
    static {
        System.loadLibrary("exif_lib1_jni_v09");
     ...
     */
    public HtcExifInterface(String filename) throws IOException {
        if (filename == null) {
     ...
     * Reads Exif tags from the specified JPEG file.
     */
    public HtcExifInterface(ParcelFileDescriptor fd) throws IOException {
        if (fd == null) {
            throw new IllegalArgumentException("fd cannot be null");
        }
        if ((fd.getFileDescriptor() == null) || (!fd.getFileDescriptor().valid())) {
    ...
    private void loadAttributes() throws IOException {
        ...
        synchronized (sLock) {
        	if (mFilename != null)
        		...
        		attrStr = getAttributesFromFDNative(mFD.getFd());
        }
    ...
    public void saveAttributes() throws IOException {
        ...
        /* >> Harvey add more logs to trace */
        Log.d(TAG, "[saveAttributes] PID: " + Process.myPid());
        /* << Harvey add more logs to trace */
    ...
    public boolean getLatLong(float output[]) {
        String latValue = mAttributes.get(HtcExifInterface.TAG_GPS_LATITUDE);
        String latRef = mAttributes.get(HtcExifInterface.TAG_GPS_LATITUDE_REF);
        String lngValue = mAttributes.get(HtcExifInterface.TAG_GPS_LONGITUDE);
        String lngRef = mAttributes.get(HtcExifInterface.TAG_GPS_LONGITUDE_REF);
    ...
    private native String getAttributesFromFDNative(int fd);
