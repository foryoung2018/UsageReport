...
typedef struct {
    ...
    int   isMakerNote;
    int   MakerNoteTagNum;
    int   DualCam;  //add by maopei 0924
    int   Vcm;
    struct{
        int x1;
        int y1;
    ...
    // Leon: Check if containing Google Panorama format, aka GPano in XMP
    unsigned short IsPanorama;
    unsigned short Is3DMacro;
    unsigned short IsBokeh;
...
int ReadJpegFileFromFD(int fd, ReadMode_t ReadMode);
