...
public class HtcListActivity extends BaseActivity {
    ...
    public boolean isEnableAutomotive = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	mActionBarExt = new ActionBarExt(getWindow(), getActionBar());
		ActionBarContainer actionContainer = mActionBarExt.getCustomContainer(); 	
		mActionBarDropDown = new ActionBarDropDown(getApplicationContext());
		mActionBarDropDown.setPrimaryVisibility(View.VISIBLE);
		if (actionContainer != null) {
			actionContainer.addCenterView(mActionBarDropDown);
	...
	protected void setActionBarTextureDrawable(Drawable d) {
		if (mActionBarExt != null) {
			mActionBarExt.setBackgroundDrawable(d);
		}
	}
	
	public void setTitle(String title) {
		mActionBarDropDown.setPrimaryText(title);
	}
}
