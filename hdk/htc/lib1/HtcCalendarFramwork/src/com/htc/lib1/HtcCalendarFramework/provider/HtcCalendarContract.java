 ...
 */
 ...
 /**
  *  HTC: This class is cloned from CalendarContract for resolve CTS test!!
  *       Need to clone from new released framework!!
  */

 /**
 * The HtcCalendarContract copied from Google's CalendarContract
 * @exthide
 * @deprecated [Not use after L]
 */
public class HtcCalendarContract {	 // HTC remove final
    private static final String TAG = "HtcCalendar";
     ...
     */
    protected HtcCalendarContract() {}		// HTC changed to protected
     ...
     * </ul>
     */
    public static class Calendars implements BaseColumns, SyncColumns, CalendarColumns {  // HTC remove final

        /**
         * This utility class cannot be instantiated
         */
        protected Calendars() {}		// HTC changed to protected
    ...
    protected interface AttendeesColumns {
        ...
        /**
          *  The none relationship value which is defined as 0
          */
        public static final int RELATIONSHIP_NONE = 0;

        /**
          *  The attendee relationship value which is defined as 1
          */
        public static final int RELATIONSHIP_ATTENDEE = 1;

        /**
          *  The organizer relationship value which is defined as 2
          */
        public static final int RELATIONSHIP_ORGANIZER = 2;

        /**
          *  The performer relationship value which is defined as 3
          */
        public static final int RELATIONSHIP_PERFORMER = 3;

        /**
          *  The speaker relationship value which is defined as 4
          */
        ...
        /**
          * The none type value is defined as 0
          */
        public static final int TYPE_NONE = 0;

        /**
          * The required type value is defined as 1
          */
        public static final int TYPE_REQUIRED = 1;

        /**
          * The optional type value is defined as 2
          */
        ...
        /**
          * The none attendee status value is defined as 0
          */
        public static final int ATTENDEE_STATUS_NONE = 0;

        /**
          * The accepted attendee status value is defined as 1
          */
        public static final int ATTENDEE_STATUS_ACCEPTED = 1;

        /**
          * The declined attendee status value is defined as 2
          */
        public static final int ATTENDEE_STATUS_DECLINED = 2;

        /**
          * The invited attendee status value is defined as 3
          */
        public static final int ATTENDEE_STATUS_INVITED = 3;

        /**
          * The tentative attendee status value is defined as 4
          */
    ...
    protected interface EventsColumns {
        ...
        /**
          * The tentative status value is defined as 0
          */
        public static final int STATUS_TENTATIVE = 0;

        /**
          * The status status value is defined as 1
          */
        public static final int STATUS_CONFIRMED = 1;

        /**
          * The canceled status value is defined as 2
          */
     ...
     */
    public static class EventsEntity implements BaseColumns, SyncColumns, EventsColumns {	  // HTC remove final
        /**
     ...
     */
    public static class Events implements BaseColumns, SyncColumns, EventsColumns,	// HTC removed final
            CalendarColumns {
         ...
         * This utility class cannot be instantiated
         */
        protected Events() {}		// HTC changed to protected
     ...
     */
    public static class Instances implements BaseColumns, EventsColumns, CalendarColumns {	 // HTC remove final
         ...
         * This utility class cannot be instantiated
         */
        protected Instances() {}	// HTC changed protected
    ...
    /**
      * Calendar cache columns interface
      */
    ...
    protected interface RemindersColumns {
        ...
        /**
          * The default method of Reminder column.
          */
        public static final int METHOD_DEFAULT = 0;

        /**
          * The alert method of Reminder column.
          */
        public static final int METHOD_ALERT = 1;

        /**
          * The email method of Reminder column.
          */
        public static final int METHOD_EMAIL = 2;

        /**
          * The sms method of Reminder column.
          */
        public static final int METHOD_SMS = 3;

        /**
          * The alarm method of Reminder column.
          */
     ...
     * </ul>
     */
    public static class Reminders implements BaseColumns, RemindersColumns, EventsColumns {	 // HTC remove final
        private static final String REMINDERS_WHERE = CalendarContract.Reminders.EVENT_ID + "=?";

        /**
          * The content provider of reminders
          */
        @SuppressWarnings("hiding")
         ...
         * This utility class cannot be instantiated
         */
        protected Reminders() {}	// HTC changed protected
    ...
    /**
      * Calendar alert columns interface
      */
     ...
     * state of a reminder.
     */
    public static class CalendarAlerts implements BaseColumns,
            CalendarAlertsColumns, EventsColumns, CalendarColumns {	// HTC remove final
         ...
         * This utility class cannot be instantiated
         */
        protected CalendarAlerts() {}		// HTC changed protected
...
//	    String selection = ALARM_TIME + ">=" + millis;
        ...
        public static void scheduleAlarm(Context context, AlarmManager manager, long alarmTime) {
            ...
            Uri uri = Uri.withAppendedPath(CalendarContract.CONTENT_URI, new StringBuilder().append(ALARM_TIME).append("/").append(alarmTime).toString());
            intent.setData(uri);                        
            //[hTC]-, mod
    ...
    /**
      * extended property columns interface
      */
