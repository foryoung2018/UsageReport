...
public class Duration
{
    ...
    public void parse(String str) throws DateException
    {
        ...
        //[++]Modify to avoid StringIndexOutOfBoundsException by peter li ,20120806
        //Find from Calendar Test Case DurationTest.java while running verifyDuration("P", 1, 0, 0, 0, 0, 0);
        //if (len < index) {
        if (len <= index) {
            return ;
        }
        ...
        //[++]Add to avoid StringIndexOutOfBoundsException by peter li ,20120806
        //Find from Calendar Test Case DurationTest.java while running verifyDuration("P", 1, 0, 0, 0, 0, 0);
        if (len <= index) {
            return ;
        }
